...
void refreshScreen3(SDL_Renderer* renderer,SDL_Texture *background,SDL_Texture *red1,SDL_Texture *red2,
                    ...
                    int &status,int &mode,int &score,int &stage, vector<int> &color,vector<int> &color_master,bool &rewatch);
...
void refreshScreen4_1( SDL_Renderer* renderer,SDL_Texture *background,SDL_Texture *red1,SDL_Texture *red2,
                       ...
                       Mix_Chunk *sound3,int x,int y,int &status,int &score,int &record,int &stage, vector<int> &color, vector<int> &color_master,const bool mouseDown, bool &rewatch);
...
void refreshScreen4_2( SDL_Renderer* renderer,SDL_Texture *background,SDL_Texture *red1,SDL_Texture *red2,
                       ...
                       int x,int y,int &status,int &score,int &stage,int &record, vector<int> &color, vector<int> &color_master,const bool mouseDown, bool &rewatch);
        ...
        if(status==3)
        {
            ...
            if(mode==1)
            {
                ...
                refreshScreen3(renderer,background,red1,red2,orange1,orange2,yellow1,yellow2,green1,green2,
                               ...
                               sound6, sound7,status,mode,score1,stage1,color1,color_master1,rewatch);
                refreshScreen4_1( renderer,background,red1,red2,orange1,orange2,yellow1,yellow2,back_,_0,_1,_2,_3,_4,_5,
                                  ...
                                  1200,600,status,score1,record1,stage1, color1,color_master1,false,rewatch);
            }
            if(mode==2)
            {
                refreshScreen3(renderer,background,red1,red2,orange1,orange2,yellow1,yellow2,green1,green2,
                               blue1,blue2,pink1,pink2,purple1,purple2,_round,great,_0,_1,_2,_3,_4,_5,_6,_7,_8,_9,sound1, sound2, sound3, sound4, sound5,
                               sound6, sound7,status,mode,score2,stage2,color2,color_master2,rewatch);
                refreshScreen4_2( renderer,background,red1,red2,orange1,orange2,yellow1,yellow2,green1,green2,
                                  ...
                                  1200,600,status,score2,stage2,record2, color2,color_master2,false,rewatch);
            ...
            if(mode==3)
            {
                refreshScreen3(renderer,background,red1,red2,orange1,orange2,yellow1,yellow2,green1,green2,
                               blue1,blue2,pink1,pink2,purple1,purple2,_round,great,_0,_1,_2,_3,_4,_5,_6,_7,_8,_9,sound1, sound2, sound3, sound4, sound5,
                               sound6, sound7,status,mode,score3,stage3,color3,color_master3,rewatch);
                refreshScreen4_3(renderer,background,red1,red2,orange1,orange2,yellow1,yellow2,green1,green2,blue1,
                                 ...
                                 1200,600,status,score3,stage3,record3,color3,color_master3,false,rewatch);
            }
            ...
            if (e.type == SDL_MOUSEBUTTONDOWN)
            {
                ...
                if(status==4)
                {
                    if(mode==1)
                    {
                        refreshScreen4_1( renderer,background,red1,red2,orange1,orange2,yellow1,yellow2,back_,_0,_1,_2,_3,_4,_5,
                                          _6,_7,_8,_9,score_txt,highest_record,watch_again,win_sound,sound1,sound2,sound3,
                                          x,y,status,score1,record1,stage1, color1,color_master1,true,rewatch);
                    }
                    if(mode==2)
                    {
                        refreshScreen4_2( renderer,background,red1,red2,orange1,orange2,yellow1,yellow2,green1,green2,
                                          blue1,blue2,back_,_0,_1,_2,_3,_4,_5,_6,_7,_8,_9,score_txt,highest_record,
                                          watch_again,win_sound,sound1,sound2,sound3, sound4, sound5,
                                          x,y,status,score2,stage2,record2, color2,color_master2,true,rewatch);
                    ...
                    if(mode==3)
                    {
                        refreshScreen4_3(renderer,background,red1,red2,orange1,orange2,yellow1,yellow2,green1,green2,blue1,
                                         ...
                                         x,y,status,score3,stage3,record3,color3,color_master3,true,rewatch);
                    }
                }
                if(status==-1)
                {
            ...
            if(status==4)
            {
                ...
                if(mode==2)
                {
                    refreshScreen4_2( renderer,background,red1,red2,orange1,orange2,yellow1,yellow2,green1,green2,
                                      blue1,blue2,back_,_0,_1,_2,_3,_4,_5,_6,_7,_8,_9,score_txt,highest_record,
                                      watch_again,win_sound,sound1,sound2,sound3, sound4, sound5,
                                      x,y,status,score2,stage2,record2, color2,color_master2,false,rewatch);
                ...
                if(mode==3)
                {
                    refreshScreen4_3(renderer,background,red1,red2,orange1,orange2,yellow1,yellow2,green1,green2,blue1,
                                     blue2,pink1,pink2,purple1,purple2,back_,_0,_1,_2,_3,_4,_5,_6,_7,_8,_9,score_txt,highest_record,watch_again,win_sound,
                                     sound1, sound2, sound3, sound4, sound5, sound6, sound7,
                                     x,y,status,score3,stage3,record3,color3,color_master3,false,rewatch);
                }
            }
